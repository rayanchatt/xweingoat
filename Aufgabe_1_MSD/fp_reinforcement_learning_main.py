...
slope, intercept, *_ = stats.linregress(t_fit, y_fit)
D_fit = 0.5 * slope
...
# Gefittete Gerade (mit Achsenabschnitt)
ax.plot(t_axis, intercept + slope * t_axis,
        '--', label=rf'Fit: $2Dt$, $D_{{\rm fit}}={D_fit:.3f}$')
...
NAME = "Chatt_Weingart"
fig.savefig(f"Aufgabe 1 MSD D{learner.D:.2f} {D_fit:.3f} {NAME} {now}.png",
            bbox_inches="tight")
plt.show()